...
function getAssetGroups() {
  var assetManifestPaths = ["./AltibizTheme/Assets.json"];
  var assetGroups = [];
...
function resolveAssetGroupPaths(assetGroup, assetManifestPath) {
  ...
  //assetGroup.webroot = path.join("./Web/wwwroot/", path.basename(assetGroup.basePath), path.dirname(assetGroup.output));
}
